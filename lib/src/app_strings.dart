...
class SmartLocalize {
  ...
  /// Returns the confirmation message: "Do you really want to log out?".
  static String get confirmLogout => "confirm_logout".tr();

  /// Returns the confirmation message: "Are you sure you want to exit?".
  static String get exit => "exit".tr();

  /// Returns the confirmation message: "Do you want to save changes?".
  static String get confirmSaveChanges => "save_changes".tr();

  /// Returns the confirmation message: "Are you sure you want to discard changes?".
  static String get discardChanges => "discard_changes".tr();

  /// Returns the confirmation message: "Are you sure you want to remove this item?".
  static String get removeItem => "remove_item".tr();

  /// Returns the confirmation message: "Are you sure you want to reset settings to default?".
  static String get resetSettings => "reset_settings".tr();

  /// Returns the confirmation message: "This file already exists. Do you want to overwrite it?".
  static String get overwriteFile => "overwrite_file".tr();

  /// Returns the confirmation message: "Are you sure you want to submit the form?".
  static String get confirmSubmitForm => "submit_form".tr();

  /// Returns the confirmation message: "Are you sure you want to cancel your subscription?".
  static String get confirmCancelSubscription => "cancel_subscription".tr();

  /// Returns the confirmation message: "Do you really want to unsubscribe?".
  static String get confirmUnsubscribe => "unsubscribe".tr();

  /// Returns the confirmation message: "Changes you made may not be saved. Do you really want to leave?".
  static String get leavePage => "leave_page".tr();

  /// Returns the confirmation message: "Are you sure you want to sign out?".
  static String get confirmSignOut => "sign_out".tr();

  /// Returns the confirmation message: "Are you sure you want to deactivate your account?".
  static String get deactivateAccount => "deactivate_account".tr();

  /// Returns the confirmation message: "Do you want to remove this person from your friends list?".
  static String get removeFriend => "remove_friend".tr();

  /// Returns the confirmation message: "Are you sure you want to block this user?".
  static String get blockUser => "block_user".tr();

  /// Returns the confirmation message: "Are you sure you want to clear your history?".
  static String get clearHistory => "clear_history".tr();

  /// Returns the confirmation message: "Do you want to restart the application?".
  static String get restart => "restart".tr();

  /// Returns the confirmation message: "Are you sure you want to shut down?".
  static String get shutdown => "shutdown".tr();

  /// Returns the confirmation message: "Apply changes now?".
  static String get applyChanges => "apply_changes".tr();

  /// Returns the confirmation message: "An update is available. Do you want to update now?".
  static String get confirmUpdateNow => "update_now".tr();

  /// Returns the confirmation message: "Do you accept the terms and conditions?".
  static String get confirmAcceptTerms => "accept_terms".tr();

  /// Returns the confirmation message: "Do you confirm this payment?".
  static String get confirmPayment => "confirm_payment".tr();

  /// Returns the confirmation message: "Are you sure you want to send this message?".
  static String get confirmSendMessage => "send_message".tr();

  /// Returns the confirmation message: "Do you want to download this file?".
  static String get confirmDownloadFile => "download_file".tr();

  /// Returns the confirmation message: "Do you want to enable this feature?".
  static String get enableFeature => "enable_feature".tr();

  /// Returns the confirmation message: "Do you want to disable this feature?".
  static String get disableFeature => "disable_feature".tr();

  /// Returns the confirmation message: "Are you sure you want to remove this photo?".
  static String get removePhoto => "remove_photo".tr();

  /// Returns the confirmation message: "Do you really want to leave this group?".
  static String get leaveGroup => "leave_group".tr();

  /// Returns the confirmation message: "Are you sure you want to end the call?".
  static String get endCall => "end_call".tr();

  /// Returns the confirmation message: "Restore default settings?".
  static String get restoreDefaults => "restore_defaults".tr();

  /// Returns the confirmation message: "This action cannot be undone. Permanently delete?".
  static String get permanentDelete => "permanent_delete".tr();

  /// Returns the confirmation message: "Do you want to remove this device?".
  static String get removeDevice => "remove_device".tr();

  /// Returns the confirmation message: "Do you want to sync now?".
  static String get syncNow => "sync_now".tr();

  /// Returns the confirmation message: "Do you want to send feedback?".
  static String get confirmSendFeedback => "send_feedback".tr();

  /// Returns the confirmation message: "Please confirm your action.".
  static String get confirmAction => "confirm_action".tr();

  /// Returns the confirmation message: "Are you sure you want to cancel your order?".
  static String get cancelOrder => "cancel_order".tr();

  /// Returns the confirmation message: "Proceed to payment?".
  static String get proceedPayment => "proceed_payment".tr();

  /// Returns the confirmation message: "Do you want to upgrade your plan?".
  static String get upgradePlan => "upgrade_plan".tr();

  /// Returns the confirmation message: "Are you sure you want to close your account?".
  static String get closeAccount => "close_account".tr();

  /// Returns the confirmation message: "Are you sure you want to empty the trash?".
  static String get emptyTrash => "empty_trash".tr();

  /// Returns the confirmation message: "Change language now?".
  static String get changeLanguage => "change_language".tr();

  /// Returns the confirmation message: "Do you want to delete this message?".
  static String get deleteMessage => "delete_message".tr();

  /// Returns the confirmation message: "Do you confirm your reservation?".
  static String get confirmReservation => "confirm_reservation".tr();

  /// Returns the confirmation message: "Are you sure you want to submit your application?".
  static String get submitApplication => "submit_application".tr();

  /// Returns the confirmation message: "Remove from favorites?".
  static String get removeFavorite => "remove_favorite".tr();

  /// Returns the confirmation message: "Do you confirm this booking?".
  static String get confirmBooking => "confirm_booking".tr();

  /// Returns the confirmation message: "Do you accept this invitation?".
  static String get acceptInvitation => "accept_invitation".tr();

  /// Returns the confirmation message: "Do you want to decline this invitation?".
  static String get declineInvitation => "decline_invitation".tr();

  /// Returns the confirmation message: "Do you want to replace the existing item?".
  static String get replaceItem => "replace_item".tr();

  /// Returns the confirmation message: "Do you want to connect your social account?".
  static String get connectSocial => "connect_social".tr();

  /// Returns the confirmation message: "Do you want to disconnect your social account?".
  static String get disconnectSocial => "disconnect_social".tr();

  /// Returns the confirmation message: "Do you confirm your registration?".
  static String get confirmRegistration => "confirm_registration".tr();

  /// Returns the confirmation message: "Apply this coupon?".
  static String get confirmApplyCoupon => "apply_coupon".tr();

  /// Returns the confirmation message: "Would you like to leave a review?".
  static String get leaveReview => "leave_review".tr();

  /// Returns the confirmation message: "Do you want to reset your password?".
  static String get resetPassword => "reset_password".tr();

  /// Returns the confirmation message: "Please verify your identity.".
  static String get verifyIdentity => "verify_identity".tr();

  /// Returns the confirmation message: "Do you allow access?".
  static String get allowAccess => "allow_access".tr();

  /// Returns the confirmation message: "Do you deny access?".
  static String get denyAccess => "deny_access".tr();

  /// Returns the confirmation message: "Do you accept cookies?".
  static String get acceptCookies => "accept_cookies".tr();

  /// Returns the confirmation message: "Do you confirm your email address?".
  static String get confirmEmail => "confirm_email".tr();

  /// Returns the confirmation message: "Exit without saving?".
  static String get exitWithoutSaving => "exit_without_saving".tr();

  /// Returns the confirmation message: "Turn on notifications?".
  static String get turnOnNotifications => "turn_on_notifications".tr();

  /// Returns the confirmation message: "Turn off notifications?".
  static String get turnOffNotifications => "turn_off_notifications".tr();

  /// Returns the confirmation message: "Do you accept this request?".
  static String get acceptRequest => "accept_request".tr();

  /// Returns the confirmation message: "Do you reject this request?".
  static String get rejectRequest => "reject_request".tr();

  /// Returns the confirmation message: "Do you want to restore this item?".
  static String get restoreItem => "restore_item".tr();

  /// Returns the confirmation message: "Are you sure you want to archive this item?".
  static String get archiveItem => "archive_item".tr();

  /// Returns the confirmation message: "Do you want to unarchive this item?".
  static String get unarchiveItem => "unarchive_item".tr();

  /// Returns the confirmation message: "Mark all as read?".
  static String get markAsRead => "mark_as_read".tr();

  /// Returns the confirmation message: "Are you sure you want to clear all notifications?".
  static String get clearNotifications => "clear_notifications".tr();

  /// Returns the confirmation message: "Do you confirm the submission?".
  static String get confirmSubmission => "confirm_submission".tr();

  /// Returns the confirmation message: "Send invitation?".
  static String get sendInvitation => "send_invitation".tr();

  /// Returns the confirmation message: "Do you want to connect this device?".
  static String get connectDevice => "connect_device".tr();

  /// Returns the confirmation message: "Do you want to disconnect this device?".
  static String get disconnectDevice => "disconnect_device".tr();

  /// Returns the confirmation message: "Upgrade now?".
  static String get upgradeNow => "upgrade_now".tr();

  /// Returns the confirmation message: "Start your free trial?".
  static String get startTrial => "start_trial".tr();

  /// Returns the confirmation message: "End your trial period?".
  static String get endTrial => "end_trial".tr();

  /// Returns the confirmation message: "Do you want to reactivate your account?".
  static String get reactivateAccount => "reactivate_account".tr();

  /// Returns the confirmation message: "Do you confirm the purchase?".
  static String get confirmPurchase => "confirm_purchase".tr();

  /// Returns the confirmation message: "Add this item to your cart?".
  static String get confirmAddToCart => "add_to_cart".tr();

  /// Returns the confirmation message: "Do you want to leave the chat?".
  static String get leaveChat => "leave_chat".tr();

  /// Returns the confirmation message: "Do you want to join this group?".
  static String get joinGroup => "join_group".tr();

  /// Returns the confirmation message: "Are you sure you want to report this user?".
  static String get reportUser => "report_user".tr();

  /// Returns the confirmation message: "Do you want to share your location?".
  static String get shareLocation => "share_location".tr();

  /// Returns the confirmation message: "Enable location services?".
  static String get enableLocation => "enable_location".tr();

  /// Returns the confirmation message: "Disable location services?".
  static String get disableLocation => "disable_location".tr();

  /// Returns the confirmation message: "Allow access to your camera?".
  static String get enableCamera => "enable_camera".tr();

  /// Returns the confirmation message: "Allow access to your microphone?".
  static String get enableMicrophone => "enable_microphone".tr();

  /// Returns the confirmation message: "Do you want to sync your contacts?".
  static String get syncContacts => "sync_contacts".tr();

  /// Returns the confirmation message: "Import data now?".
  static String get importData => "import_data".tr();

  /// Returns the confirmation message: "Export data now?".
  static String get exportData => "export_data".tr();

  /// Returns the confirmation message: "Reset all filters?".
  static String get resetFilters => "reset_filters".tr();

  /// Returns the confirmation message: "Apply this filter?".
  static String get applyFilter => "apply_filter".tr();

  /// Returns the confirmation message: "Save as draft?".
  static String get saveAsDraft => "save_as_draft".tr();

  /// Returns the confirmation message: "Publish now?".
  static String get publishNow => "publish_now".tr();

  /// Returns the confirmation message: "Schedule this post?".
  static String get schedulePost => "schedule_post".tr();

  /// Returns the confirmation message: "Do you want to join this event?".
  static String get confirmJoinEvent => "join_event".tr();

  /// Returns the confirmation message: "Do you want to leave this event?".
  static String get leaveEvent => "leave_event".tr();

  /// Returns the confirmation message: "Delete this comment?".
  static String get removeComment => "remove_comment".tr();

  /// Returns the confirmation message: "Confirm download?".
  static String get confirmDownload => "confirm_download".tr();

  /// Returns the confirmation message: "Confirm upload?".
  static String get confirmUpload => "confirm_upload".tr();

  /// Returns the confirmation message: "Start over?".
  static String get startOver => "start_over".tr();

  /// Returns the confirmation message: "Test the connection?".
  static String get testConnection => "test_connection".tr();

  /// Returns the confirmation message: "Switch to another account?".
  static String get switchAccount => "switch_account".tr();

  /// Returns the confirmation message: "Update your preferences?".
  static String get updatePreferences => "update_preferences".tr();

  /// Returns the confirmation message: "Enable synchronization?".
  static String get enableSync => "enable_sync".tr();

  /// Returns the confirmation message: "Disable synchronization?".
  static String get disableSync => "disable_sync".tr();

  /// Returns the confirmation message: "Confirm your selection?".
  static String get confirmSelection => "confirm_selection".tr();

  /// Returns the confirmation message: "Clear cache?".
  static String get clearCache => "clear_cache".tr();

  /// Returns the confirmation message: "Accept data sharing?".
  static String get acceptSharing => "accept_sharing".tr();

  /// Returns the confirmation message: "Decline data sharing?".
  static String get declineSharing => "decline_sharing".tr();

  /// Returns the confirmation message: "Proceed without saving?".
  static String get proceedWithoutSaving => "proceed_without_saving".tr();
...
// ================== placeholder  =====================================
  /// Returns the placeholder text: "Enter text here...".
  static String get enterText => "enter_text".tr();

  /// Returns the prompt: "Select an option".
  static String get selectOption => "select_option".tr();

  /// Returns the placeholder text: "Enter your username".
  static String get enterUsername => "enter_username".tr();

  /// Returns the placeholder text: "Enter your password".
  static String get enterPassword => "enter_password".tr();

  /// Returns the placeholder text: "Enter your email address".
  static String get enterEmail => "enter_email".tr();

  /// Returns the placeholder text: "Enter your phone number".
  static String get enterPhone => "enter_phone".tr();

  /// Returns the placeholder text: "Enter your mobile number".
  static String get enterMobile => "enter_mobile".tr();

  /// Returns the placeholder text: "Enter your address".
  static String get enterAddress => "enter_address".tr();

  /// Returns the placeholder text: "Enter your city".
  static String get enterCity => "enter_city".tr();

  /// Returns the placeholder text: "Enter your state".
  static String get enterState => "enter_state".tr();

  /// Returns the placeholder text: "Enter your postal code".
  static String get enterPostalCode => "enter_postal_code".tr();

  /// Returns the prompt: "Select your country".
  static String get selectCountry => "select_country".tr();

  /// Returns the placeholder text: "Enter your first name".
  static String get enterFirstName => "enter_first_name".tr();

  /// Returns the placeholder text: "Enter your last name".
  static String get enterLastName => "enter_last_name".tr();

  /// Returns the prompt: "Add your comments...".
  static String get addComments => "add_comments".tr();

  /// Returns the placeholder text: "Search products...".
  static String get searchProducts => "search_products".tr();

  /// Returns the placeholder text: "Search users...".
  static String get searchUsers => "search_users".tr();

  /// Returns the prompt: "Filter results".
  static String get filterResults => "filter_results".tr();

  /// Returns the prompt: "Choose a file".
  static String get chooseFile => "choose_file".tr();

  /// Returns the placeholder text: "Write a reply...".
  static String get writeReply => "write_reply".tr();

  /// Returns the placeholder text: "Enter a new password".
  static String get newPassword => "new_password".tr();

  /// Returns the placeholder text: "Confirm your password".
  static String get confirmPassword => "confirm_password".tr();

  /// Returns the placeholder text: "Enter your current password".
  static String get oldPassword => "old_password".tr();

  /// Returns the placeholder text: "Enter your card number".
  static String get enterCardNumber => "enter_card_number".tr();

  /// Returns the placeholder text: "Enter the amount".
  static String get enterAmount => "enter_amount".tr();

  /// Returns the prompt: "Type your question here...".
  ...
  /// Returns the prompt: "Select language".
  static String get selectLanguage => "select_language".tr();

  /// Returns the prompt: "Select currency".
  static String get selectCurrency => "select_currency".tr();

  /// Returns the placeholder text: "Enter code".
  static String get enterCode => "enter_code".tr();

  /// Returns the prompt: "Enter the characters you see".
  static String get enterCaptcha => "enter_captcha".tr();

  /// Returns the placeholder text: "Enter location".
  static String get enterLocation => "enter_location".tr();

  /// Returns the placeholder text: "Write a comment...".
  static String get writeComment => "write_comment".tr();

  /// Returns the placeholder text: "Search here...".
  static String get searchHere => "search_here".tr();

  /// Returns the placeholder text: "Enter promo code".
  static String get promoCode => "promo_code".tr();

  /// Returns the placeholder text: "Enter IP address".
  static String get enterIpAddress => "enter_ip_address".tr();

  /// Returns the placeholder text: "Enter port number".
  static String get enterPort => "enter_port".tr();

  /// Returns the placeholder text: "Enter API key".
  static String get apiKey => "api_key".tr();

  /// Returns the placeholder text: "Enter file name".
  static String get fileName => "file_name".tr();

  /// Returns the placeholder text: "Enter folder name".
  static String get folderName => "folder_name".tr();

  /// Returns the prompt: "Search settings...".
  static String get searchSettings => "search_settings".tr();

  /// Returns the prompt: "Filter by".
  static String get filterBy => "filter_by".tr();

  /// Returns the prompt: "Sort by".
  static String get sortBy => "sort_by".tr();

  /// Returns the placeholder text: "Enter invoice number".
  static String get invoiceNumber => "invoice_number".tr();

  /// Returns the placeholder text: "Enter order number".
  static String get orderNumber => "order_number".tr();

  /// Returns the prompt: "Type your feedback here...".
  static String get feedbackMessage => "feedback_message".tr();

  /// Returns the prompt: "Describe the issue...".
  static String get bugDescription => "bug_description".tr();

  /// Returns the placeholder text: "Enter tags".
  static String get enterTags => "enter_tags".tr();

  /// Returns the prompt: "Select category".
  static String get selectCategory => "select_category".tr();

  /// Returns the prompt: "Enter your credentials".
  static String get enterCredentials => "enter_credentials".tr();

  /// Returns the placeholder text: "Enter OTP".
  static String get enterOtp => "enter_otp".tr();

  /// Returns the placeholder text: "Search contacts...".
  static String get searchContacts => "search_contacts".tr();

  /// Returns the placeholder text: "Search messages...".
  static String get searchMessages => "search_messages".tr();

  /// Returns the placeholder text: "Search files...".
  static String get searchFiles => "search_files".tr();

  /// Returns the placeholder text: "Enter URL".
  static String get enterUrl => "enter_url".tr();

  /// Returns the prompt: "Type a message...".
  static String get typeMessage => "type_message".tr();

  /// Returns the placeholder text: "Enter name".
  static String get enterName => "enter_name".tr();

  /// Returns the placeholder text: "Enter value".
  static String get enterValue => "enter_value".tr();

  /// Returns the prompt: "Choose a color".
  static String get chooseColor => "choose_color".tr();

  /// Returns the prompt: "Select gender".
  static String get selectGender => "select_gender".tr();

  /// Returns the prompt: "Select status".
  static String get selectStatus => "select_status".tr();

  /// Returns the prompt: "Select role".
  static String get selectRole => "select_role".tr();

  /// Returns the prompt: "Select priority".
  static String get selectPriority => "select_priority".tr();

  /// Returns the placeholder text: "Enter comment...".
  static String get enterComment => "enter_comment".tr();

  /// Returns the placeholder text: "Enter feedback...".
  static String get enterFeedback => "enter_feedback".tr();

  /// Returns the placeholder text: "Enter note...".
  static String get enterNote => "enter_note".tr();

  /// Returns the placeholder text: "Search locations...".
  static String get searchLocations => "search_locations".tr();

  /// Returns the placeholder text: "Search events...".
  static String get searchEvents => "search_events".tr();

  /// Returns the placeholder text: "Search tasks...".
  static String get searchTasks => "search_tasks".tr();

  /// Returns the placeholder text: "Enter keyword".
  static String get enterKeyword => "enter_keyword".tr();

  /// Returns the prompt: "Add new item".
  static String get addNewItem => "add_new_item".tr();

  /// Returns the prompt: "Select image".
  static String get selectImage => "select_image".tr();

  /// Returns the prompt: "Select file".
  static String get selectFile => "select_file".tr();

  /// Returns the prompt: "Upload avatar".
  static String get uploadAvatar => "upload_avatar".tr();

  /// Returns the placeholder text: "Enter code here".
  static String get enterCodeHere => "enter_code_here".tr();

  /// Returns the placeholder text: "Enter phone number".
  static String get enterPhoneNumber => "enter_phone_number".tr();

  /// Returns the placeholder text: "Enter mobile number".
  static String get enterMobileNumber => "enter_mobile_number".tr();

  /// Returns the placeholder text: "Enter fax number".
  static String get enterFaxNumber => "enter_fax_number".tr();

  /// Returns the placeholder text: "Search articles...".
  static String get searchArticles => "search_articles".tr();

  /// Returns the placeholder text: "Search posts...".
  static String get searchPosts => "search_posts".tr();

  /// Returns the placeholder text: "Search friends...".
  static String get searchFriends => "search_friends".tr();

  /// Returns the prompt: "Add a comment...".
  static String get addComment => "add_comment".tr();

  /// Returns the prompt: "Select state".
  static String get selectState => "select_state".tr();

  /// Returns the prompt: "Select city".
  static String get selectCity => "select_city".tr();

  /// Returns the prompt: "Select province".
  static String get selectProvince => "select_province".tr();

  /// Returns the placeholder text: "Search nearby...".
  static String get searchNearby => "search_nearby".tr();

  /// Returns the prompt: "Tell us about yourself...".
  static String get enterBio => "enter_bio".tr();

  /// Returns the placeholder text: "Enter description".
  static String get enterDescription => "enter_description".tr();

  /// Returns the placeholder text: "Enter title".
  static String get enterTitle => "enter_title".tr();

  /// Returns the placeholder text: "Enter subtitle".
  static String get enterSubtitle => "enter_subtitle".tr();

  /// Returns the placeholder text: "Enter subject here".
  static String get enterSubjectHere => "enter_subject_here".tr();

  /// Returns the placeholder text: "Enter your message".
  static String get enterMessage => "enter_message".tr();

  /// Returns the placeholder text: "Confirm new password".
  static String get confirmNewPassword => "confirm_new_password".tr();

  /// Returns the placeholder text: "Search music...".
  static String get searchMusic => "search_music".tr();

  /// Returns the placeholder text: "Search videos...".
  static String get searchVideos => "search_videos".tr();

  /// Returns the placeholder text: "Search movies...".
  static String get searchMovies => "search_movies".tr();

  /// Returns the placeholder text: "Search games...".
  static String get searchGames => "search_games".tr();

  /// Returns the placeholder text: "Enter license key".
  static String get enterLicenseKey => "enter_license_key".tr();

  /// Returns the placeholder text: "Enter activation code".
  static String get enterActivationCode => "enter_activation_code".tr();

  /// Returns the placeholder text: "Enter serial number".
  static String get enterSerialNumber => "enter_serial_number".tr();

  /// Returns the placeholder text: "Search history...".
  static String get searchHistory => "search_history".tr();

  /// Returns the placeholder text: "Search notifications...".
  static String get searchNotifications => "search_notifications".tr();

  /// Returns the prompt: "Enter answer here".
  static String get enterAnswerHere => "enter_answer_here".tr();

  /// Returns the prompt: "Enter comment here...".
  static String get enterCommentHere => "enter_comment_here".tr();

  /// Returns the placeholder text: "Search groups...".
  static String get searchGroups => "search_groups".tr();

  /// Returns the placeholder text: "Search pages...".
  static String get searchPages => "search_pages".tr();

  /// Returns the prompt: "Enter feedback here...".
  static String get enterFeedbackHere => "enter_feedback_here".tr();

  /// Returns the prompt: "Enter note here...".
  static String get enterNoteHere => "enter_note_here".tr();

  /// Returns the placeholder text: "Enter full name".
  static String get enterFullName => "enter_full_name".tr();

  /// Returns the prompt: "Select time zone".
  static String get selectTimezone => "select_timezone".tr();

  /// Returns the prompt: "Select theme".
  static String get selectTheme => "select_theme".tr();

  /// Returns the placeholder text: "Enter API key".
  static String get enterApiKey => "enter_api_key".tr();

  /// Returns the placeholder text: "Enter client ID".
  static String get enterClientId => "enter_client_id".tr();

  /// Returns the placeholder text: "Enter client secret".
  static String get enterClientSecret => "enter_client_secret".tr();

  /// Returns the placeholder text: "Enter token".
  static String get enterToken => "enter_token".tr();

  /// Returns the prompt: "Enter security answer".
  static String get enterSecurityAnswer => "enter_security_answer".tr();

  /// Returns the prompt: "Enter OTP here".
  static String get enterOtpHere => "enter_otp_here".tr();

  /// Returns the prompt: "Enter verification code".
  static String get enterVerificationCode => "enter_verification_code".tr();

  /// Returns the prompt: "Enter old password".
  static String get enterOldPassword => "enter_old_password".tr();

  /// Returns the prompt: "Enter new password".
  static String get enterNewPassword => "enter_new_password".tr();

  /// Returns the placeholder text: "Search documents...".
  static String get searchDocuments => "search_documents".tr();

  /// Returns the placeholder text: "Search images...".
  static String get searchImages => "search_images".tr();

  /// Returns the prompt: "Enter file name".
  static String get enterFileName => "enter_file_name".tr();

  /// Returns the prompt: "Enter folder name".
  static String get enterFolderName => "enter_folder_name".tr();

  /// Returns the placeholder text: "Enter group name".
  static String get enterGroupName => "enter_group_name".tr();

  /// Returns the placeholder text: "Enter project name".
  static String get enterProjectName => "enter_project_name".tr();

  /// Returns the placeholder text: "Enter task name".
  static String get enterTaskName => "enter_task_name".tr();

  /// Returns the placeholder text: "Enter event name".
  static String get enterEventName => "enter_event_name".tr();

  /// Returns the placeholder text: "Enter meeting name".
  static String get enterMeetingName => "enter_meeting_name".tr();

  /// Returns the placeholder text: "Enter location name".
  static String get enterLocationName => "enter_location_name".tr();

  /// Returns the placeholder text: "Enter company name".
  static String get enterCompanyName => "enter_company_name".tr();

  /// Returns the placeholder text: "Enter organization name".
  static String get enterOrganizationName => "enter_organization_name".tr();

  /// Returns the placeholder text: "Enter department name".
  static String get enterDepartmentName => "enter_department_name".tr();

  /// Returns the placeholder text: "Enter position title".
  static String get enterPositionTitle => "enter_position_title".tr();

  /// Returns the placeholder text: "Enter role name".
  static String get enterRoleName => "enter_role_name".tr();

  /// Returns the prompt: "Enter tag".
  static String get enterTag => "enter_tag".tr();

  /// Returns the placeholder text: "Enter category name".
  static String get enterCategoryName => "enter_category_name".tr();

  /// Returns the placeholder text: "Enter product name".
  static String get enterProductName => "enter_product_name".tr();

  /// Returns the placeholder text: "Enter service name".
  static String get enterServiceName => "enter_service_name".tr();

  /// Returns the placeholder text: "Enter price".
  static String get enterPrice => "enter_price".tr();

  /// Returns the placeholder text: "Enter quantity".
  static String get enterQuantity => "enter_quantity".tr();

  /// Returns the placeholder text: "Enter discount".
  static String get enterDiscount => "enter_discount".tr();

  /// Returns the placeholder text: "Enter tax".
  static String get enterTax => "enter_tax".tr();

  /// Returns the placeholder text: "Enter total".
  static String get enterTotal => "enter_total".tr();

  /// Returns the placeholder text: "Enter subtotal".
  static String get enterSubtotal => "enter_subtotal".tr();

  /// Returns the placeholder text: "Enter shipping address".
  static String get enterShippingAddress => "enter_shipping_address".tr();

  /// Returns the placeholder text: "Enter billing address".
  static String get enterBillingAddress => "enter_billing_address".tr();

  /// Returns the placeholder text: "Enter payment method".
  static String get enterPaymentMethod => "enter_payment_method".tr();

  /// Returns the placeholder text: "Enter cardholder name".
  static String get enterCardholderName => "enter_cardholder_name".tr();

  /// Returns the placeholder text: "Enter expiration date".
  static String get enterExpirationDate => "enter_expiration_date".tr();

  /// Returns the placeholder text: "Enter CVV".
  static String get enterCvv => "enter_cvv".tr();

  /// Returns the placeholder text: "Enter bank name".
  static String get enterBankName => "enter_bank_name".tr();

  /// Returns the placeholder text: "Enter account number".
  static String get enterAccountNumber => "enter_account_number".tr();

  /// Returns the placeholder text: "Enter routing number".
  static String get enterRoutingNumber => "enter_routing_number".tr();

  /// Returns the placeholder text: "Enter transaction ID".
  static String get enterTransactionId => "enter_transaction_id".tr();

  /// Returns the placeholder text: "Enter invoice number".
  static String get enterInvoiceNumber => "enter_invoice_number".tr();

  /// Returns the placeholder text: "Enter order number".
  static String get enterOrderNumber => "enter_order_number".tr();

  /// Returns the placeholder text: "Enter reference number".
  static String get enterReferenceNumber => "enter_reference_number".tr();

  /// Returns the placeholder text: "Enter tracking number".
  static String get enterTrackingNumber => "enter_tracking_number".tr();

  /// Returns the placeholder text: "Enter client name".
  static String get enterClientName => "enter_client_name".tr();

  /// Returns the placeholder text: "Enter customer name".
  static String get enterCustomerName => "enter_customer_name".tr();

  /// Returns the placeholder text: "Enter vendor name".
  static String get enterVendorName => "enter_vendor_name".tr();

  /// Returns the placeholder text: "Enter supplier name".
  static String get enterSupplierName => "enter_supplier_name".tr();

  /// Returns the placeholder text: "Enter employee name".
  static String get enterEmployeeName => "enter_employee_name".tr();

  /// Returns the placeholder text: "Enter manager name".
  static String get enterManagerName => "enter_manager_name".tr();

  /// Returns the placeholder text: "Enter admin name".
  static String get enterAdminName => "enter_admin_name".tr();

  /// Returns the placeholder text: "Enter user name".
  static String get enterUserName => "enter_user_name".tr();

  /// Returns the placeholder text: "Enter member name".
  static String get enterMemberName => "enter_member_name".tr();

  /// Returns the placeholder text: "Enter team name".
  static String get enterTeamName => "enter_team_name".tr();

  /// Returns the placeholder text: "Enter project description".
  static String get enterProjectDescription => "enter_project_description".tr();

  /// Returns the placeholder text: "Enter task description".
  static String get enterTaskDescription => "enter_task_description".tr();

  /// Returns the placeholder text: "Enter event description".
  static String get enterEventDescription => "enter_event_description".tr();

  /// Returns the placeholder text: "Enter meeting description".
  static String get enterMeetingDescription => "enter_meeting_description".tr();

  /// Returns the placeholder text: "Enter note description".
  static String get enterNoteDescription => "enter_note_description".tr();

  /// Returns the placeholder text: "Enter comment description".
  static String get enterCommentDescription => "enter_comment_description".tr();

  /// Returns the prompt: "Enter message here...".
  static String get enterMessageHere => "enter_message_here".tr();

  /// Returns the placeholder text: "Search everything...".
  static String get searchEverything => "search_everything".tr();

  /// Returns the placeholder text: "Search people...".
  static String get searchPeople => "search_people".tr();

  /// Returns the placeholder text: "Search places...".
  static String get searchPlaces => "search_places".tr();

  /// Returns the placeholder text: "Search things...".
  static String get searchThings => "search_things".tr();

  /// Returns the placeholder text: "Search notes...".
  static String get searchNotes => "search_notes".tr();

  /// Returns the placeholder text: "Search projects...".
  static String get searchProjects => "search_projects".tr();

  /// Returns the placeholder text: "Search meetings...".
  static String get searchMeetings => "search_meetings".tr();

  /// Returns the placeholder text: "Search calendar...".
  static String get searchCalendar => "search_calendar".tr();
